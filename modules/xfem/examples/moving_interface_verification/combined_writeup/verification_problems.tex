...
\subsection{}
% ###############################################################################
\begin{frame}[t]\frametitle{1D, Cartesian, Homogeneous Material Problem Description}
  \begin{block}{PDE}
...
%			\begin{center}
%			\includegraphics[scale=0.66]{figures/Screen-GlobalParams}
%			\end{center}
%		\column{0.66\linewidth}
%			\begin{center}
%			\includegraphics[scale=0.66]{figures/Screen-Executioner}
%			\end{center}
%	\end{columns}
%	\begin{center}
%	\includegraphics[scale=0.66]{figures/Screen-Constraints}
%	\end{center}
%\end{frame}
%
%\begin{frame}[t]\frametitle{Computational Results}
%  	\begin{columns}
%		\column{0.48\linewidth}
%			\begin{center}
%			\includegraphics[scale=0.09]{figures/comp_sol_0p5}\\
%			$t=0.5$
%			
%			\null
%			
%			\includegraphics[scale=0.09]{figures/comp_sol_1p0}\\
%			$t=1.0$
%			\end{center}
%		\column{0.48\linewidth}
%			\begin{center}
%			\includegraphics[scale=0.09]{figures/comp_sol_1p5}\\
%			$t=1.5$			
%			
%			\null
%			
%			\includegraphics[scale=0.09]{figures/comp_sol_2p0}\\
%			$t=2.0$
%			\end{center}
%	\end{columns}
%\end{frame}
...
%		\column{0.48\linewidth}
%			\begin{center}
%			\includegraphics[scale=0.17]{figures/compare_solves_0p5}\\
%			$t=0.5$
%			
%			\null
%			
%			\includegraphics[scale=0.17]{figures/compare_solves_1p0}\\
%			$t=1.0$
%			\end{center}
%		\column{0.48\linewidth}
%			\begin{center}
%			\includegraphics[scale=0.17]{figures/compare_solves_1p5}\\
%			$t=1.5$			
%			
%			\null
%			
%			\includegraphics[scale=0.17]{figures/compare_solves_2p0}\\
%			$t=2.0$
%			\end{center}
%	\end{columns}
%\end{frame}
...
%	\begin{center}
%		\includegraphics[scale=0.4]{figures/L2_err_norms}
%	\end{center}
%\end{frame}
%
%\begin{frame}[t]\frametitle{XFEM Cut Location Distance from Actual Interface Position vs Time}
%	\begin{center}
%		\includegraphics[scale=0.4]{figures/interface_dist}
%	\end{center}
%\end{frame}
%
%\begin{frame}[t]\frametitle{Interface Cut Location: Calculated or Interpolated?}
%	\begin{center}
%		\includegraphics[scale=0.4]{figures/interface_comp}
%	\end{center}
%\end{frame}

%\begin{frame}[t]\frametitle{Mesh Refinement: L2 Error Norms at Each Timestep}
%	\begin{center}
%		\includegraphics[scale=0.4]{figures/L2_err_norms_comp_dx}
%	\end{center}
%\end{frame}
%
%\begin{frame}[t]\frametitle{Mesh Refinement: XFEM Cut Location Distance from Actual Interface Position vs Time}
%	\begin{center}
%		\includegraphics[scale=0.4]{figures/interface_dist_comp_dx}
%	\end{center}
%\end{frame}
