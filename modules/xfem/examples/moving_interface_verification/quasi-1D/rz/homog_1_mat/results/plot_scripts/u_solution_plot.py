...
for i in range(0,4):
  ...
  moos_04_temp = np.genfromtxt('../u_solutions/nx4/1D_rz_homog1mat_nx04-0.'
   +tstep_num[i]+'.csv',delimiter=',',skip_header=1)
  # Extract XFEM nx=1 solution data
  xfem_01_temp = np.genfromtxt(
    '../u_solutions/nx1/1D_rz_homog1mat_lsf_xfem_nx01-0.'+tstep_num[i]+'.csv',
    delimiter=',',skip_header=1)
  # Extract XFEM nx=4 solution data
  xfem_04_temp = np.genfromtxt(
    '../u_solutions/nx4/1D_rz_homog1mat_lsf_xfem_nx04-0.'+tstep_num[i]+'.csv',
    delimiter=',',skip_header=1)
...
plt.savefig(savdir+'1D_rz_homog1mat_u_vs_x_05.png')
...
plt.savefig(savdir+'1D_rz_homog1mat_u_vs_x_10.png')
...
plt.savefig(savdir+'1D_rz_homog1mat_u_vs_x_15.png')
...
plt.savefig(savdir+'1D_rz_homog1mat_u_vs_x_20.png')
