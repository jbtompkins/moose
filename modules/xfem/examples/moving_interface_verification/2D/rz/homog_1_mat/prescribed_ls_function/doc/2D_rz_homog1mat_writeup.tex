...
\begin{frame}[t]\frametitle{Results Comparison}
  	\begin{columns}
		\column{0.48\linewidth}
			\begin{center}
			\includegraphics[scale=0.17]{figures/2D_rz_homog1mat_u_vs_x_05}\\
			$t=0.5$
			
			\null
			
			\includegraphics[scale=0.17]{figures/2D_rz_homog1mat_u_vs_x_10}\\
			$t=1.0$
			\end{center}
		\column{0.48\linewidth}
			\begin{center}
			\includegraphics[scale=0.17]{figures/2D_rz_homog1mat_u_vs_x_15}\\
			$t=1.5$			
			
			\null
			
			\includegraphics[scale=0.17]{figures/2D_rz_homog1mat_u_vs_x_20}\\
			$t=2.0$
			\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}[t]\frametitle{L2 Error Norms at Each Timestep}
	\begin{center}
		\includegraphics[scale=0.4]{figures/2D_rz_homog1mat_L2_Errs}
	\end{center}
\end{frame}
