...
\begin{frame}\frametitle{Numerical Parameters}
  	\begin{columns}
		\column{0.32\linewidth}
			\begin{center}
			\includegraphics[scale=0.4]{figures/Screen-GlobalParams-2Drzh1m}
			\end{center}
		\column{0.66\linewidth}
			\begin{center}
			\includegraphics[scale=0.4]{figures/Screen-Executioner-2Drzh1m}
			\end{center}
	\end{columns}
	\begin{center}
	\includegraphics[scale=0.4]{figures/Screen-Constraints-2Drzh1m}
	\end{center}
\end{frame}
  ...
  Upper plane is nx=1, ny=1; lower plane is nx=4, ny=4
  	\begin{columns}
		\column{0.48\linewidth}
			\begin{center}
			\includegraphics[scale=0.2]{figures/2D_rz_homog1mat_u_vs_x_05}\\
			\tiny$t=0.5$
			
			\null
			
			\includegraphics[scale=0.2]{figures/2D_rz_homog1mat_u_vs_x_10}\\
			$t=1.0$
			\end{center}
		\column{0.48\linewidth}
			\begin{center}
			\includegraphics[scale=0.2]{figures/2D_rz_homog1mat_u_vs_x_15}\\
			\tiny$t=1.5$			
			
			\null
			
			\includegraphics[scale=0.2]{figures/2D_rz_homog1mat_u_vs_x_20}\\
			$t=2.0$
			\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}[t]\frametitle{L2 Error Norms at Each Timestep}
  	\begin{columns}
		\column{0.5\linewidth}
			\begin{center}
			\includegraphics[scale=0.4]{figures/2D_rz_homog1mat_nx1ny1_L2_Errs}
			\end{center}
		\column{0.5\linewidth}
			\begin{center}
			\includegraphics[scale=0.4]{figures/2D_rz_homog1mat_nx4ny4_L2_Errs}
			\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}[t]\frametitle{Mesh Refinement Effects on Error at x=1, y=1}
	\begin{center}
		\includegraphics[scale=0.4]{figures/2D_rz_homog1mat_neumann_comp}
	\end{center}
\end{frame}
