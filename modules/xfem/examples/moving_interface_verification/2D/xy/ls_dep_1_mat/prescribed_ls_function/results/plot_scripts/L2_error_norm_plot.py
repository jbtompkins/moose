...
for i in range(0,len(ts)):
  xfem_01_temp = np.genfromtxt(
    '../u_solutions/nx1ny1/2D_xy_ls1mat_lsf_xfem_nx1ny1-0.'+str(i+3)+'.csv',
    delimiter=',',skip_header=1)
  xfem_04_temp = np.genfromtxt(
    '../u_solutions/nx4ny4/2D_xy_ls1mat_lsf_xfem_nx4ny4-0.'+str(i+3)+'.csv',
    delimiter=',',skip_header=1)
...
plt.savefig(savdir+'2D_xy_ls1mat_nx1ny1_L2_Errs.png')
...
plt.ylabel('L2 Error Norm')
plt.ticklabel_format(axis='y',style='sci',scilimits=(1,2))
plt.savefig(savdir+'2D_xy_ls1mat_nx4ny4_L2_Errs.png')
