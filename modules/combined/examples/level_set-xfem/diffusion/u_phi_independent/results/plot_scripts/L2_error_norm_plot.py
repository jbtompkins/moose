...
for i in range(0,len(ts)):
  xfem_temp = np.genfromtxt(
    '../solutions/ls-xfem-2D_rz_homog1mat-0.'+str(i)+'.csv',
...
plt.savefig(savdir+'ls-xfem-2D_rz_homog1mat_phi_L2_Errs.png')
...
plt.ticklabel_format(axis='y',style='sci',scilimits=(1,2))
plt.savefig(savdir+'ls-xfem-2D_rz_homog1mat_u_L2_Errs.png')
