...
\begin{frame}[t]\frametitle{2D, Cylindrical, Homogeneous Material Problem Description}
  \begin{block}{Transient, 2D, RZ Heat Transfer PDE}
...
%			\begin{center}
%			\includegraphics[scale=0.4]{figures/Screen-GlobalParams-lsx-2Drzh1m}
%			\end{center}
%		\column{0.66\linewidth}
%			\begin{center}
%			\includegraphics[scale=0.4]{figures/Screen-Executioner-lsx-2Drzh1m}
%			\end{center}
%	\end{columns}
%	\begin{center}
%	\includegraphics[scale=0.4]{figures/Screen-Constraints-lsx-2Drzh1m}
%	\end{center}
%\end{frame}
